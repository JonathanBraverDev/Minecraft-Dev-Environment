...
# Change to server directory for operations
Push-Location $serverPath

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "   PaperMC Server One-Click Installer" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "   Installing to: $serverPath" -ForegroundColor Gray
Write-Host ""
...
Write-Host "To start your server, run the 'start.bat' file in the server folder."
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
